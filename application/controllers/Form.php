...
class Form extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $form->jumlah_sepeda = null;
        $form->jumlah_motor = null;
        $form->jumlah_mobil = null;
        $form->jumlah_truck = null;
        $form->transportasi = null;
        $form->menggunakan_hp = null;
        $form->uang_lahan = null;
        $form->alasan_lahan = null;
        ...
        $form->alasan_banding = null;
        $form->pendapatan_cukup = null;
        $form->alasan_pendapat = null;
