...
class Form_m extends CI_Model
{
    ...
    public function add($post)
    {
        $params = [
            ...
            // 'sirkulasi_udara' => $post ['sirkulasi_udara'],
            ...
            // 'transportasi' => $post ['trasnportasi'],
            ...
            // 'kerjasama_lingkungan' => $post ['kerjasama_lingkugan'],
