            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('form/process') ?>" method="post">
                        <p class="h2"><ins>BIODATA ENUMERATOR</ins>
                            <p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="tingkat_partisipasi" value="tidak_aktif" <?php if ($row->tingkat_partisipasi == 'tidak_aktif') {
                                                                                                            echo "checked";
                                                                                                        } ?>>Tidak aktif<br>
                                    <input type="radio" name="tingkat_partisipasi" value="tidak_terlibat" <?php if ($row->tingkat_partisipasi == 'tidak_terlibat') {
                                                                                                                echo "checked";
                                                                                                            } ?>>Tidak Terlibat<br>
