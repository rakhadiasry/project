...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <script>
    // jumlah kelamin 
    $(function() {
      var pieChartCanvas = $('#jmlkChart').get(0).getContext('2d')
      var pieChart = new Chart(pieChartCanvas)
      var PieData = [{
          value: <?= $dataif->jml_pria; ?>,
          color: '#f56954',
          highlight: '#f56954',
          label: 'Pria'
        },
        {
          value: <?= $dataif->jml_wanita; ?>,
          color: '#00a65a',
          highlight: '#00a65a',
          label: 'Wanita'
        }
  ...
  <script>
    // jumlah suku 
    $(function() {
      var pieChartCanvas = $('#sukuChart').get(0).getContext('2d')
      var Chart = new Chart(pieChartCanvas)
      var PieData = [{
          value: <?= $dataif->suku_minangkabau; ?>,
          color: '#f56954',
          highlight: '#f56954',
          label: 'Minangkabau'
        },
        {
          value: <?= $dataif->suku_jawa; ?>,
          color: '#00a65a',
          highlight: '#00a65a',
          label: 'Jawa'
        }
